...
class AirBnbDayRangeControllerWrapper extends React.Component {
  constructor(props) {
    super(props);
...
AirBnbDayRangeControllerWrapper.propTypes = propTypes;
AirBnbDayRangeControllerWrapper.defaultProps = defaultProps;

export default AirBnbDayRangeControllerWrapper;
